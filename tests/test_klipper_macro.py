...
def test_macro_uebergibt_temp_und_flow():
    # PA_CALIBRATE MUSS TEMP und FLOW als Macro-Parameter annehmen und an
    # pa_generate weiterreichen (Spec §5 Entscheidung 2: filament-
    # spezifische Werte werden in den GCode eingebacken).
    text = _CFG.read_text(encoding="utf-8")
